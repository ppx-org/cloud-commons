	...
	public void execute(final String sql) throws DataAccessException {
		...
		class ExecuteStatementCallback implements StatementCallback<Object>, SqlProvider {
			...
			public Object doInStatement(Statement stmt) throws SQLException {
				// dengxz
				ControllerContext.getAccessLog().addSql(sql);
				Date begin = new Date();
				ControllerContext.getAccessLog().addSqlBeginTime(begin);
				
				stmt.execute(sql);
				
				ControllerContext.getAccessLog().addSqlSpendTime(System.currentTimeMillis() - begin.getTime());
				ControllerContext.getAccessLog().addSqlCount(-1);
		...
		class QueryStatementCallback implements StatementCallback<T>, SqlProvider {
			...
			public T doInStatement(Statement stmt) throws SQLException {
				...
				try {
					...
					ControllerContext.getAccessLog().addSqlSpendTime(System.currentTimeMillis() - begin.getTime());
					ControllerContext.getAccessLog().addSqlCount(count);
	...
	public int update(final String sql) throws DataAccessException {
		...
		class UpdateStatementCallback implements StatementCallback<Integer>, SqlProvider {
			...
			public Integer doInStatement(Statement stmt) throws SQLException {
				...
				ControllerContext.getAccessLog().addSqlSpendTime(System.currentTimeMillis() - begin.getTime());
				ControllerContext.getAccessLog().addSqlCount(rows);
