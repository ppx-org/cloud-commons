...
public abstract class AbstractJackson2HttpMessageConverter extends AbstractGenericHttpMessageConverter<Object> {
	...
	private Object readJavaType(JavaType javaType, HttpInputMessage inputMessage) throws IOException {
		try {
			...
			if (PropertiesConfig.isAccessDebugEnabled()) {
				...
				ControllerContext.getAccessLog().setInJson(baos.toString());
	...
	protected void writeInternal(Object object, @Nullable Type type, HttpOutputMessage outputMessage)
		...
		try {
			...
			// dengxz
			if (PropertiesConfig.isAccessDebugEnabled()) {
				if (ControllerContext.getAccessLog() != null) {
					ControllerContext.getAccessLog().setOutJson(objectWriter.writeValueAsString(value));
				}
			}
